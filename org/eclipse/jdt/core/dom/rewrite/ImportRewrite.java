	...
	public final TextEdit rewriteImports(IProgressMonitor monitor) throws CoreException {
		...
		try {
			...
			if (usedAstRoot == null) {
				...
				usedAstRoot= (CompilationUnit) parser.createAST(subMonitor.newChild(1));
			}
			...
			ImportRewriteAnalyzer.RewriteResult result= computer.analyzeRewrite(subMonitor.newChild(1));
