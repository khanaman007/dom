...
public final class AST {
	...
	public JSXTextCharacter newJSXTextCharacter() {
		return new JSXTextCharacter(this);
	}
	public JSXText newJSXText() {
		return new JSXText(this);
	}
	public JSXIdentifierPart newJSXIdentifierPart() {
		return new JSXIdentifierPart(this);
	}
	
	public JSXIdentifierStart newJSXIdentifierStart() {
		return new JSXIdentifierStart(this);
	}
	public JSXChild newJSXChild() {
		return new JSXChild(this);
	}
	
	public JSXElement newJSXElement() {
		return new JSXElement(this);
	}
	
	public JSXElementName newJSXElementName() {
		return new JSXElementName(this);
	}
	
	public JSXAttribute newJSXAttribute() {
		return new JSXAttribute(this);
	}
	
	public JSXAttributeDeclarationExpression newJSXAttributeDeclarationExpression() {
		return new JSXAttributeDeclarationExpression(this);
	}
	
	public JSXAttributeFragments newJSXAttributeFragments() {
		return new JSXAttributeFragments(this);
	}
	
	public JSXSpreadAttribute newJSXSpreadAttribute() {
		return new JSXSpreadAttribute(this);
	}
	
	public JSXChildExpression newJSXChildExpression() {
		return new JSXChildExpression(this);
	}
	public JSXClosingElement newJSXClosingElement() {
		return new JSXClosingElement(this);
	}
	
	public JSXSelfClosingElement newJSXSelfClosingElement() {
		return new JSXSelfClosingElement(this);
	}
	
	public JSXOpeningElement newJSXOpeningElement() {
		return new JSXOpeningElement(this);
	}
	public JSXIdentifier newJSXIdentifier() {
		return new JSXIdentifier(this);
	}
	public JSXNameValuePair newJSXNameValuePair() {
		return new JSXNameValuePair(this);
	}
	
	public JSXNamespacedName newJSXNamespacedName() {
		return new JSXNamespacedName(this);
	}
	
	public JSXMemberExpression newJSXMemberExpression() {
		return new JSXMemberExpression(this);
	}
