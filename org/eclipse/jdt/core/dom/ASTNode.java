...
public abstract class ASTNode {
	...
	public static final int  JSX_IDENTIFIER_NAME = 93;
	public static final int  JSXTEXT_NAME = 94;
	public static final int JSXMEMBEREXPRESSION_NAME = 95;
	public static final int JSXNAMESPACED_NAME = 96;

	public  static final int JSXIDENTIFIER_START_NAME = 97;

	public  static final int JSXELEMENT_NAME = 98;

	public static final int JSXCLOSING_ELEMENT_NAME = 99;

	public static final int JSX_NAME_VALUE = 100;
	public static final int JSX_ATTIBUTE = 101;
	public static final int JSX_SPREAD_ATTIBUTE = 102;
	public static final int JSX_ATTRIBUTE_DECLARATION_STATEMENT =103;
	public static final int JSX_OPENING_ELEMENT_NAME =104;

	public static final int JSX_SELFCLOSING_ELEMENT_NAME = 105;
	public static final int JSX_CHILD_NAME = 106;
	public static final int JSX_CHILDEN_DECLARATION_NAME = 107;
	public static final int  JSX_IDENTIFIER_PART = 108;
	...
	public static Class nodeClassForType(int nodeType) {
		switch (nodeType) {
			...
			case JSX_IDENTIFIER_NAME :
				return JSXIdentifier.class;	
			case JSXTEXT_NAME :
				return JSXText.class;
			case JSXMEMBEREXPRESSION_NAME :
			     return JSXMemberExpression.class;
			case JSXNAMESPACED_NAME :
			     return JSXNamespacedName.class;
			case JSXIDENTIFIER_START_NAME :
			     return JSXIdentifierStart.class; 
			case JSXELEMENT_NAME :
			     return JSXElementName.class; 
			case JSXCLOSING_ELEMENT_NAME :
			     return JSXSelfClosingElement.class;   
			     
			case JSX_NAME_VALUE :
			     return JSXNameValuePair.class; 
			case JSX_ATTIBUTE :
			     return JSXAttribute.class; 
			case JSX_SPREAD_ATTIBUTE :
			     return JSXSpreadAttribute.class;  
			case JSX_ATTRIBUTE_DECLARATION_STATEMENT :
			     return JSXAttributeDeclarationExpression.class; 
			     
			case JSX_OPENING_ELEMENT_NAME :
			     return JSXOpeningElement.class; 
			case JSX_SELFCLOSING_ELEMENT_NAME :
			     return JSXSelfClosingElement.class;    
			case JSX_CHILD_NAME :
			     return JSXChild.class;        
			case JSX_CHILDEN_DECLARATION_NAME :
			     return JSXChildExpression.class;  
