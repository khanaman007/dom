...
public class JSXElementName extends Name {
	...
	public static final SimplePropertyDescriptor IDENTIFIER_PROPERTY =
		new SimplePropertyDescriptor(JSXElementName.class, "identifier", Name.class, MANDATORY); //$NON-NLS-1$
	 ...
	 */
	void internalSetIdentifier(Name ident) {
		preValueChange(IDENTIFIER_PROPERTY);
