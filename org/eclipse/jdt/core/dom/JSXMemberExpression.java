...
public class JSXMemberExpression extends Name {
	...
	public static final ChildPropertyDescriptor QUALIFIER_PROPERTY =
			new ChildPropertyDescriptor(JSXMemberExpression.class, "qualifier", Name.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
		...
		public static final ChildPropertyDescriptor NAME_PROPERTY =
			new ChildPropertyDescriptor(JSXMemberExpression.class, "name", JSXIdentifier.class, MANDATORY, NO_CYCLE_RISK); //$NON-NLS-1$
		...
		static {
			...
			createPropertyList(JSXMemberExpression.class, propertyList);
		 ...
		 */
		private JSXIdentifier name = null;
		...
		public JSXIdentifier getName() {
			if (this.name == null) {
				...
				synchronized (this) {
					if (this.name == null) {
						preLazyInit();
						this.name = new JSXIdentifier(this.ast);
		 ...
		 * </ul>
		 */
		public void setName(JSXIdentifier name) {
			if (name == null) {
				throw new IllegalArgumentException();
			}
